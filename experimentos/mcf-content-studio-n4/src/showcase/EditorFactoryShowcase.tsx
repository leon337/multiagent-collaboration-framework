...
export const EditorFactoryShowcase=()=>{
 ...
 return <AbsoluteFill style={{background:designTokens.color.background,color:designTokens.color.text,fontFamily:'Inter,system-ui,sans-serif',paddingTop:socialCoreContentInsets.top,paddingRight:socialCoreContentInsets.right,paddingBottom:socialCoreContentInsets.bottom,paddingLeft:socialCoreContentInsets.left}}>
   ...
   <div style={{fontSize:24,color:designTokens.color.muted,marginTop:18}}>drag · resize · rotate · snap · align · nudge · multi-track</div>
   <div style={{display:'grid',gridTemplateColumns:'1fr 1.3fr',gap:28,marginTop:34,height:540}}>
     <div style={{border:'1px solid '+designTokens.color.line,borderRadius:28,padding:16,background:designTokens.color.surface}}>
       <div style={{fontSize:22,fontWeight:800}}>COMPONENTES</div>
       {['Title','Diagram','Browser','Quiz','StickRig','SoundCue'].map((item,i)=><div key={item} style={{marginTop:12,padding:'12px 12px',borderRadius:14,background:i===2?designTokens.color.surfaceStrong:'#0d1320',border:i===2?'1px solid '+designTokens.color.accent:'1px solid transparent',fontSize:18}}>{item}</div>)}
     </div>
   ...
   <div style={{marginTop:18,border:'1px solid '+designTokens.color.line,borderRadius:24,padding:20,background:designTokens.color.surface}}>
