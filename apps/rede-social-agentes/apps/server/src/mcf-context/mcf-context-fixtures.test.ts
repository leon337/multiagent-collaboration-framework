  ...
  it('pairs the Capsule with Registry identity and records only a sourced snapshot', () => {
    ...
    expect(capsule).toMatchObject({
      ...
      snapshot: {
        ...
        current_status:
          'FOUR_REPOSITORY_CONTEXT_FABRIC_AND_PROVIDER_READ_ADAPTERS_LAB_PASS__MAIN_AND_STAGING_VERIFIED__PROVIDER_CAPSULES_SYNCED__FINAL_READONLY_RECOVERY_4_OF_4_PASS',
        next_action:
          'Treat the versioned 4/4 Receipt as read-only evidence; require a fresh recovery before any later operational-currentness claim and a new human gate before provider activation or material work.',
        blockers: [
      ...
      observed_at: '2026-08-24T04:14:24.195Z',
    });
