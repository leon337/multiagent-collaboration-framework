  ...
  it('pairs the Capsule with Registry identity and records only a sourced snapshot', () => {
    ...
    expect(capsule).toMatchObject({
      ...
      snapshot: {
        ...
        next_action:
          'Review the exact reconciled NextGen planning package published by this mission; re-read Issues 164 and 165 plus PRs 170, 174, 176, 177, 180, and 182 live; preserve PRs 175, 179, and 181 as current compatibility surfaces; and require explicit LEANDRO disposition, F1.4, and implementation-boundary decisions before NX-0.',
        blockers: [
          ...
          'PR 179 merged GUI/window protocol, schema, fixtures, and a pure qualifier without runtime producer, consumer, or window control. Its post-merge status text remains stale; draft PR 180 is a noncanonical correction input.',
          ...
          'Draft PRs 174, 176, 177, 180, and 182 are outside main and remain noncanonical inputs; they do not authorize continuity duplication, qualification claims, runtime, provider, or VPS action.',
