...
export default async function ReviewQueue(){
  ...
  return <div className="page"><section className="page-head"><div><span>REVIEW QUEUE</span><h1>O que precisa de decisão humana</h1><p>A fila mostra somente o batch em REVIEW mais recente de cada missão. Versões anteriores permanecem no histórico e nada aqui aprova, publica ou encerra HUMAN_GATE automaticamente.</p></div></section>
