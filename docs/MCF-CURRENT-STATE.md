...
Estado atual do contrato de UI: `mcf-ui-semantic-contract/v1` versão `1.1.0`. A partir desta versão, a área de Detalhes do projeto e Configurações do projeto também possui IDs semânticos canônicos documentados no manual.
