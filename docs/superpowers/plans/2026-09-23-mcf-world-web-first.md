...
- [x] **Step 2: Add PR CI that executes the test file**
...
- [x] **Step 3: Open/update draft PR and verify RED**

Expected: CI fails because `apps/mcf-world-web/src/world-domain.js` does not exist.

- [x] **Step 4: Record RED evidence in phase validation artifact**
...
- [x] **Step 4: Implement `isWithinDistance` minimally**

Use X/Z Euclidean distance and include equality at boundary.

- [x] **Step 5: Run the full World domain suite**
...
- [x] **Step 2: Run static contract test and verify RED**
...
- [x] **Step 1: Build semantic HTML shell**
...
- [x] **Step 2: Implement restrictive Browser Surface adapter**
...
- [x] **Step 3: Implement Three.js scene adapter**
...
- [x] **Step 4: Implement movement/camera interaction loop**
...
- [x] **Step 5: Keep world alive while Browser Surface is open**
...
- [x] **Step 6: Run both World test files**
...
- [x] **Step 1: Add failing server contract test**
...
- [x] **Step 3: Implement dependency-free static server**
...
- [x] **Step 4: Document Windows 10 and Linux run commands**
...
- [x] **Step 1: Populate PLAN/REPORT/DECISIONS/CHECKPOINT**
...
- [x] **Step 2: Populate VALIDATION/VALIDATION-FULL/SMOKE**
...
- [x] **Step 4: Verify the branch against acceptance criteria**
...
- [x] **Step 7: Update mission status**
