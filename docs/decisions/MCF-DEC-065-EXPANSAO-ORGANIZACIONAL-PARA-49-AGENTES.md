# MCF-DEC-065 — Expansão Organizacional para 49 Agentes

**Status:** APROVADA — integração canônica pelo change-set desta decisão  
**Data:** 2026-08-23  
...
MCF-DEC-050 permanece como registro histórico da matriz de 29 agentes. Após a integração deste change-set, a matriz vigente passa a ser `docs/matrices/MCF-MATRIZ-CONSOLIDADA-DE-COMPETENCIAS-49-AGENTES.md`.
