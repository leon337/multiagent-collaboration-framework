...
Conduzir desenho técnico, integração e coordenação da implementação dentro da arquitetura e do escopo aprovados.
...
- desenho técnico, integração, implementação coordenada e notas técnicas;
