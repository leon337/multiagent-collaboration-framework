...
Avaliar ameaças, autenticação, autorização, segredos e vulnerabilidades e exigir controles técnicos proporcionais ao risco.
...
- ameaças, controles, achados de segurança e risco residual;
...
Não substitui governança regulatória de IA. Não pode ampliar escopo, inventar evidência, ocultar falha, alterar autoridade ou executar ação externa sem permissão compatível.
