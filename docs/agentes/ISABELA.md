...
Definir telas, linguagem visual, componentes e estados visuais coerentes com o fluxo e os requisitos aprovados.
...
- telas, componentes, estados visuais e especificações de interface;
...
Não substitui implementação frontend. Não pode ampliar escopo, inventar evidência, ocultar falha, alterar autoridade ou executar ação externa sem permissão compatível.
